...
% • Todo quien tiene un niño es feliz (introduzca una relación de un
% argumento feliz)
feliz(X):- progenitor(X, _).

% • Para todo X, si X tiene un niño que tiene una hermana, entonces X
% tiene dos niños (introduzca una
